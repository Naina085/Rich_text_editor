...
function insertVideo() {
  ...
  resizeHandle.setAttribute('style', 'position:absolute;width:auto ; height:auto; background-color:#3b82f6; cursor:se-resize;');
  ...
  videoResizable(embedElement, resizeHandle);
  // console.log("iframe ", embedElement);
  // console.log("div ", resizeHandle);

  resizeHandle.appendChild(embedElement);
  // console.log("div + iframe ", resizeHandle);
...
function videoResizable(element, handle) {
